...
playerName,
  ...
  pickedLine =
    ExpressYourElf.RandomizeUtil.GetRandomized("dance_player_message", danceLines, contextSalt)

  return ExpressYourElf.Helpers.parseText(getRandomPrefix(playerName) .. pickedLine, {
...
playerName,
  ...
  if ExpressYourElfVars.allowMatureContent then
    ...
    table.insert(
      danceLines,
      "${targetGuyGirl}, I can thrill you more than any ghost would dare to try"
    )
  ...
  pickedLine =
    ExpressYourElf.RandomizeUtil.GetRandomized("dance_target_message", danceLines, contextSalt)
...
function ExpressYourElf.DanceWithMe.run()
  ...
  -- asign
  playerName, playerGender, playerClass, playerRace, playerLevel =
    ExpressYourElf.Helpers.GetPlayerInformation()
  playerHisHer = string.lower(ExpressYourElf.Helpers.GetHisHer(playerGender))
  playerSirMam = string.lower(ExpressYourElf.Helpers.GetSirMam(playerGender))
  playerGuyGirl = string.lower(ExpressYourElf.Helpers.GetGuyGirl(playerGender))
  playerManWoman = string.lower(ExpressYourElf.Helpers.GetManWoman(playerGender))
  playerHeShe = string.lower(ExpressYourElf.Helpers.GetHeShe(playerGender))
  playerHimHer = string.lower(ExpressYourElf.Helpers.GetHimHer(playerGender))
  ...
  if (UnitName("target") and UnitPlayerControlled("target")) then
    ...
    targetSirMam = string.lower(ExpressYourElf.Helpers.GetSirMam(targetGender))
    targetGuyGirl = string.lower(ExpressYourElf.Helpers.GetGuyGirl(targetGender))
    targetManWoman = string.lower(ExpressYourElf.Helpers.GetManWoman(targetGender))
  end
