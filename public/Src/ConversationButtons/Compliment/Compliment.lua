...
playerName,
  ...
  if (targetRace == "Earthen") then  end
  ...
  if (targetClass == "Druid" or targetRace == "Dracthyr" or targetRace == "Tauren" or targetRace == "Highmountain Tauren") then  end
  ...
  if (targetClass == "Druid" and playerClass == "Druid") then  end

  if (targetRace == "Dracthyr") then  end

  if (targetClass == "Demon Hunter") then  end
  ...
  if (targetRace == "Vulpera") then  end

  if (targetRace == "Draenei" and targetRace == "Lightforged Draenei") then  end

  if (targetClass == "Hunter") then  end

  if (targetClass == "Warlock") then  end

  if (targetClass == "Priest") then  end

  if ((targetClass == "Mage" or playerClass == "Mage") and not (playerGender == targetGender)) then  end

  if (targetClass == "Priest" or targetClass == "Paladin" or targetClass == "Monk" or targetClass == "Warlock" or targetClass == "Mage") then  end
  ...
  if (playerClass == "Paladin" and targetClass == "Paladin") then  end
  ...
  if (ExpressYourElfVars.allowMatureContent and ExpressYourElfVars.bringBackRemoved) then
    if (playerRace == "Blood Elf" and playerGender == "female") then  end

    if (playerRace == "Demon Hunter" and playerRace == "Blood Elf" and playerGender == "female") then  end

    if (playerRace == "Goblin" and playerGender == "female") then  end

    if (playerRace == "Goblin" and targetGender == "male") then  end

    if (playerRace == "Goblin" and playerGender == "male") then  end

    if (playerRace == "Goblin" and playerGender == "male" and targetGender == "female") then  end

    if (playerRace == "Orc" and playerGender == "male") then  end

    if (playerRace == "Tauren" and playerGender == "female" and targetGender == "male") then  end

    if (playerRace == "Tauren" and playerGender == "male" and targetGender == "female") then  end

    if (playerRace == "Troll" and playerGender == "female") then  end

    if (playerRace == "Troll" and playerGender == "male") then  end

    if (playerRace == "Undead" and playerGender == "female") then  end

    if (playerRace == "Undead" and playerGender == "male") then  end

    if (playerRace == "Highmountain Tauren" and playerGender == "female") then  end

    if (playerRace == "Highmountain Tauren" and playerGender == "male") then  end

    if (playerRace == "Nightborne" and playerGender == "female" and targetGender == "male") then  end

    if (playerRace == "Nightborne" and playerGender == "female") then  end

    if (playerRace == "Nightborne" and playerGender == "male") then  end

    if (playerRace == "Draenei" and playerGender == "female") then  end

    if (playerRace == "Draenei" and playerGender == "male") then  end

    if (playerRace == "Dwarf" and playerGender == "female") then  end

    if (playerRace == "Dwarf" and playerGender == "male") then  end

    if (playerRace == "Night Elf" and playerGender == "female") then  end

    if (playerRace == "Night Elf" and playerGender == "male") then  end

    if ((playerRace == "Worgen" or targetRace == "Gilnean") and playerGender == "female") then  end

    if ((playerRace == "Worgen" or targetRace == "Gilnean") and playerGender == "male") then  end

    if (playerRace == "Dark Iron Dwarf" and playerGender == "male") then  end

    if (playerRace == "Lightforged Draenei" and playerGender == "female") then  end

    if (playerRace == "Lightforged Draenei" and playerGender == "female" and targetGender == "male") then  end

    if (playerRace == "Mechagnome" and playerGender == "female") then  end

    if (playerRace == "Pandaren" and playerGender == "female") then  end

    if (playerRace == "Pandaren" and playerGender == "male") then  end
  end
